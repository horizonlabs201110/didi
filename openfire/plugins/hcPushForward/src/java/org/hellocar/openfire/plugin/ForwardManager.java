...
public class ForwardManager implements IManager, Runnable {
	public static IManager CreateInstance(IPushAdapter push, IForwardAdapter forward) {
		return new ForwardManager(push, forward);
	}
	...
	public ForwardManager(IPushAdapter push, IForwardAdapter forward) {
		if (push == null) {
